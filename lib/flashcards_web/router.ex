defmodule FlashcardsWeb.Router do
  ...
  scope "/", FlashcardsWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{FlashcardsWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", FlashcardsWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{FlashcardsWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", FlashcardsWeb do
    ...
    live_session :current_user,
      on_mount: [{FlashcardsWeb.UserAuth, :mount_current_user}] do
